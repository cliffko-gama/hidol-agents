 ...
 * Phase 1 prompt 重構：
 * - 硬性規則提前至最頂端
 * - 寫作流程移至 Style Compass 之前（先知流程再看細節）
 * - Fan Energy 移至 Style Compass 第一位（最重要維度）
 * - 稀薄素材策略、修改模式說明移至 user message 動態注入
 * - Theme Spine 以第零步為唯一完整定義，其他處僅引用
 */
